      ...
      <div className="main-container">
        ...
        <section className="section-eight">
          ...
          <div className="custome-label">
            ...
            <p>Leveraged insights from successful competitor strategies.</p>
          </div>
          <div className="automatic-label">
            <h3>Brand Differentiation</h3>
            <p>Communicated E-Travelsim's unique selling points effectively</p>
          </div>
